"use strict";
// Transcrypt'ed from Python, 2017-10-12 16:06:21
function save () {
    ...
    */
	...
	(function () {
		...
		var save = function () {
			...
			$.ajax (dict ({'type': 'POST', 'url': '/save/{}'.format (document.getElementById ('name').value), 'contentType': 'application/json', 'data': JSON.stringify (data)}));
			event.preventDefault ();
		};
		save ();
		__pragma__ ('<all>')
			__all__.ids = ids;
			__all__.nonefunc = nonefunc;
			__all__.save = save;
		__pragma__ ('</all>')
	}) ();
   return __all__;
