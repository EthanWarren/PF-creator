"use strict";
// Transcrypt'ed from Python, 2017-10-14 14:26:39
function load () {
    ...
    */
	...
	(function () {
		var loadsheet = function (data) {
			var ds = data.py_replace ('{', '').py_replace ('}', '');
			var dl = ds.py_split (',');
			var data = dict ({});
			var __iterable0__ = dl;
			for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
				var kv = __iterable0__ [__index0__];
				var __left0__ = kv.py_split (':');
				var k = __left0__ [0];
				var v = __left0__ [1];
				var k = k.strip ("'").py_replace ("'", '');
				var v = v.strip ("'").py_replace ("'", '');
				data [k] = v;
			}
			var __iterable0__ = data.py_items ();
			for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
				var __left0__ = __iterable0__ [__index0__];
				var loadid = __left0__ [0];
				var loadvalue = __left0__ [1];
