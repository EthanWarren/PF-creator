"use strict";
// Transcrypt'ed from Python, 2017-10-05 17:58:26
function calculate () {
				...
				__init__: function (__all__) {
					var __Envir__ = __class__ ('__Envir__', [object], {
						get __init__ () {return __get__ (this, function (self) {
							...
							self.transpiler_version = '3.6.50';
	...
	__nest__ (
		...
		'barbarian', {
			__all__: {
				__inited__: false,
				__init__: function (__all__) {
					var table = dict ({1: dict ({'will': 0, 'ref': 0, 'bab': 1, 'fort': 2}), 2: dict ({'will': 0, 'ref': 0, 'bab': 2, 'fort': 3}), 3: dict ({'will': 1, 'ref': 1, 'bab': 3, 'fort': 3}), 4: dict ({'will': 1, 'ref': 1, 'bab': 4, 'fort': 4}), 5: dict ({'will': 1, 'ref': 1, 'bab': 5, 'fort': 4}), 6: dict ({'will': 2, 'ref': 2, 'bab': 6, 'fort': 5}), 7: dict ({'will': 2, 'ref': 2, 'bab': 7, 'fort': 5}), 8: dict ({'will': 2, 'ref': 2, 'bab': 8, 'fort': 6}), 9: dict ({'will': 3, 'ref': 3, 'bab': 9, 'fort': 6}), 10: dict ({'will': 3, 'ref': 3, 'bab': 10, 'fort': 7}), 11: dict ({'will': 3, 'ref': 3, 'bab': 11, 'fort': 7}), 12: dict ({'will': 4, 'ref': 4, 'bab': 12, 'fort': 8}), 13: dict ({'will': 4, 'ref': 4, 'bab': 13, 'fort': 8}), 14: dict ({'will': 4, 'ref': 4, 'bab': 14, 'fort': 9}), 15: dict ({'will': 5, 'ref': 5, 'bab': 15, 'fort': 9}), 16: dict ({'will': 5, 'ref': 5, 'bab': 16, 'fort': 10}), 17: dict ({'will': 5, 'ref': 5, 'bab': 17, 'fort': 10}), 18: dict ({'will': 6, 'ref': 6, 'bab': 18, 'fort': 11}), 19: dict ({'will': 6, 'ref': 6, 'bab': 19, 'fort': 11}), 20: dict ({'will': 6, 'ref': 6, 'bab': 20, 'fort': 12}), 'hp': 12});
					__pragma__ ('<all>')
						__all__.table = table;
					__pragma__ ('</all>')
				}
	...
	__nest__ (
		...
		'bard', {
			__all__: {
				__inited__: false,
				__init__: function (__all__) {
					var table = dict ({1: dict ({'will': 2, 'ref': 2, 'bab': 0, 'fort': 0}), 2: dict ({'will': 3, 'ref': 3, 'bab': 1, 'fort': 0}), 3: dict ({'will': 3, 'ref': 3, 'bab': 2, 'fort': 1}), 4: dict ({'will': 4, 'ref': 4, 'bab': 3, 'fort': 1}), 5: dict ({'will': 4, 'ref': 4, 'bab': 3, 'fort': 1}), 6: dict ({'will': 5, 'ref': 5, 'bab': 4, 'fort': 2}), 7: dict ({'will': 5, 'ref': 5, 'bab': 5, 'fort': 2}), 8: dict ({'will': 6, 'ref': 6, 'bab': 6, 'fort': 2}), 9: dict ({'will': 6, 'ref': 6, 'bab': 6, 'fort': 3}), 10: dict ({'will': 7, 'ref': 7, 'bab': 7, 'fort': 3}), 11: dict ({'will': 7, 'ref': 7, 'bab': 8, 'fort': 3}), 12: dict ({'will': 8, 'ref': 8, 'bab': 9, 'fort': 4}), 13: dict ({'will': 8, 'ref': 8, 'bab': 9, 'fort': 4}), 14: dict ({'will': 9, 'ref': 9, 'bab': 10, 'fort': 4}), 15: dict ({'will': 9, 'ref': 9, 'bab': 11, 'fort': 5}), 16: dict ({'will': 10, 'ref': 10, 'bab': 12, 'fort': 5}), 17: dict ({'will': 10, 'ref': 10, 'bab': 12, 'fort': 5}), 18: dict ({'will': 11, 'ref': 11, 'bab': 13, 'fort': 6}), 19: dict ({'will': 11, 'ref': 11, 'bab': 14, 'fort': 6}), 20: dict ({'will': 12, 'ref': 12, 'bab': 15, 'fort': 6}), 'hp': 8});
					__pragma__ ('<all>')
						__all__.table = table;
					__pragma__ ('</all>')
				}
	...
	__nest__ (
		...
		'cleric', {
			__all__: {
				__inited__: false,
				__init__: function (__all__) {
					var table = dict ({1: dict ({'will': 2, 'ref': 0, 'bab': 0, 'fort': 2}), 2: dict ({'will': 3, 'ref': 0, 'bab': 1, 'fort': 3}), 3: dict ({'will': 3, 'ref': 1, 'bab': 2, 'fort': 3}), 4: dict ({'will': 4, 'ref': 1, 'bab': 3, 'fort': 4}), 5: dict ({'will': 4, 'ref': 1, 'bab': 3, 'fort': 4}), 6: dict ({'will': 5, 'ref': 2, 'bab': 4, 'fort': 5}), 7: dict ({'will': 5, 'ref': 2, 'bab': 5, 'fort': 5}), 8: dict ({'will': 6, 'ref': 2, 'bab': 6, 'fort': 6}), 9: dict ({'will': 6, 'ref': 3, 'bab': 6, 'fort': 6}), 10: dict ({'will': 7, 'ref': 3, 'bab': 7, 'fort': 7}), 11: dict ({'will': 7, 'ref': 3, 'bab': 8, 'fort': 7}), 12: dict ({'will': 8, 'ref': 4, 'bab': 9, 'fort': 8}), 13: dict ({'will': 8, 'ref': 4, 'bab': 9, 'fort': 8}), 14: dict ({'will': 9, 'ref': 4, 'bab': 10, 'fort': 9}), 15: dict ({'will': 9, 'ref': 5, 'bab': 11, 'fort': 9}), 16: dict ({'will': 10, 'ref': 5, 'bab': 12, 'fort': 10}), 17: dict ({'will': 10, 'ref': 5, 'bab': 12, 'fort': 10}), 18: dict ({'will': 11, 'ref': 6, 'bab': 13, 'fort': 11}), 19: dict ({'will': 11, 'ref': 6, 'bab': 14, 'fort': 11}), 20: dict ({'will': 12, 'ref': 6, 'bab': 15, 'fort': 12}), 'hp': 8});
					__pragma__ ('<all>')
						__all__.table = table;
					__pragma__ ('</all>')
				}
	...
	__nest__ (
		...
		'fighter', {
			__all__: {
				__inited__: false,
				__init__: function (__all__) {
					var table = dict ({1: dict ({'will': 0, 'ref': 0, 'bab': 1, 'fort': 2}), 2: dict ({'will': 0, 'ref': 0, 'bab': 2, 'fort': 3}), 3: dict ({'will': 1, 'ref': 1, 'bab': 3, 'fort': 3}), 4: dict ({'will': 1, 'ref': 1, 'bab': 4, 'fort': 4}), 5: dict ({'will': 1, 'ref': 1, 'bab': 5, 'fort': 4}), 6: dict ({'will': 2, 'ref': 2, 'bab': 6, 'fort': 5}), 7: dict ({'will': 2, 'ref': 2, 'bab': 7, 'fort': 5}), 8: dict ({'will': 2, 'ref': 2, 'bab': 8, 'fort': 6}), 9: dict ({'will': 3, 'ref': 3, 'bab': 9, 'fort': 6}), 10: dict ({'will': 3, 'ref': 3, 'bab': 10, 'fort': 7}), 11: dict ({'will': 3, 'ref': 3, 'bab': 11, 'fort': 7}), 12: dict ({'will': 4, 'ref': 4, 'bab': 12, 'fort': 8}), 13: dict ({'will': 4, 'ref': 4, 'bab': 13, 'fort': 8}), 14: dict ({'will': 4, 'ref': 4, 'bab': 14, 'fort': 9}), 15: dict ({'will': 5, 'ref': 5, 'bab': 15, 'fort': 9}), 16: dict ({'will': 5, 'ref': 5, 'bab': 16, 'fort': 10}), 17: dict ({'will': 5, 'ref': 5, 'bab': 17, 'fort': 10}), 18: dict ({'will': 6, 'ref': 6, 'bab': 18, 'fort': 11}), 19: dict ({'will': 6, 'ref': 6, 'bab': 19, 'fort': 11}), 20: dict ({'will': 6, 'ref': 6, 'bab': 20, 'fort': 12}), 'hp': 10});
					__pragma__ ('<all>')
						__all__.table = table;
					__pragma__ ('</all>')
				}
	...
	__nest__ (
		...
		'monk', {
			__all__: {
				__inited__: false,
				__init__: function (__all__) {
					var table = dict ({1: dict ({'will': 2, 'ref': 2, 'bab': 0, 'fort': 2}), 2: dict ({'will': 3, 'ref': 3, 'bab': 1, 'fort': 3}), 3: dict ({'will': 3, 'ref': 3, 'bab': 2, 'fort': 3}), 4: dict ({'will': 4, 'ref': 4, 'bab': 3, 'fort': 4}), 5: dict ({'will': 4, 'ref': 4, 'bab': 3, 'fort': 4}), 6: dict ({'will': 5, 'ref': 5, 'bab': 4, 'fort': 5}), 7: dict ({'will': 5, 'ref': 5, 'bab': 5, 'fort': 5}), 8: dict ({'will': 6, 'ref': 6, 'bab': 6, 'fort': 6}), 9: dict ({'will': 6, 'ref': 6, 'bab': 6, 'fort': 6}), 10: dict ({'will': 7, 'ref': 7, 'bab': 7, 'fort': 7}), 11: dict ({'will': 7, 'ref': 7, 'bab': 8, 'fort': 7}), 12: dict ({'will': 8, 'ref': 8, 'bab': 9, 'fort': 8}), 13: dict ({'will': 8, 'ref': 8, 'bab': 9, 'fort': 8}), 14: dict ({'will': 9, 'ref': 9, 'bab': 10, 'fort': 9}), 15: dict ({'will': 9, 'ref': 9, 'bab': 11, 'fort': 9}), 16: dict ({'will': 10, 'ref': 10, 'bab': 12, 'fort': 10}), 17: dict ({'will': 10, 'ref': 10, 'bab': 12, 'fort': 10}), 18: dict ({'will': 11, 'ref': 11, 'bab': 13, 'fort': 11}), 19: dict ({'will': 11, 'ref': 11, 'bab': 14, 'fort': 11}), 20: dict ({'will': 12, 'ref': 12, 'bab': 15, 'fort': 12}), 'hp': 8});
					__pragma__ ('<all>')
						__all__.table = table;
					__pragma__ ('</all>')
				}
	...
	__nest__ (
		...
		'paladin', {
			__all__: {
				__inited__: false,
				__init__: function (__all__) {
					var table = dict ({1: dict ({'will': 2, 'ref': 0, 'bab': 1, 'fort': 2}), 2: dict ({'will': 3, 'ref': 0, 'bab': 2, 'fort': 3}), 3: dict ({'will': 3, 'ref': 1, 'bab': 3, 'fort': 3}), 4: dict ({'will': 4, 'ref': 1, 'bab': 4, 'fort': 4}), 5: dict ({'will': 4, 'ref': 1, 'bab': 5, 'fort': 4}), 6: dict ({'will': 5, 'ref': 2, 'bab': 6, 'fort': 5}), 7: dict ({'will': 5, 'ref': 2, 'bab': 7, 'fort': 5}), 8: dict ({'will': 6, 'ref': 2, 'bab': 8, 'fort': 6}), 9: dict ({'will': 6, 'ref': 3, 'bab': 9, 'fort': 6}), 10: dict ({'will': 7, 'ref': 3, 'bab': 10, 'fort': 7}), 11: dict ({'will': 7, 'ref': 3, 'bab': 11, 'fort': 7}), 12: dict ({'will': 8, 'ref': 4, 'bab': 12, 'fort': 8}), 13: dict ({'will': 8, 'ref': 4, 'bab': 13, 'fort': 8}), 14: dict ({'will': 9, 'ref': 4, 'bab': 14, 'fort': 9}), 15: dict ({'will': 9, 'ref': 5, 'bab': 15, 'fort': 9}), 16: dict ({'will': 10, 'ref': 5, 'bab': 16, 'fort': 10}), 17: dict ({'will': 10, 'ref': 5, 'bab': 17, 'fort': 10}), 18: dict ({'will': 11, 'ref': 6, 'bab': 18, 'fort': 11}), 19: dict ({'will': 11, 'ref': 6, 'bab': 19, 'fort': 11}), 20: dict ({'will': 12, 'ref': 6, 'bab': 20, 'fort': 12}), 'hp': 10});
					__pragma__ ('<all>')
						__all__.table = table;
					__pragma__ ('</all>')
				}
	...
	__nest__ (
		...
		'ranger', {
			__all__: {
				__inited__: false,
				__init__: function (__all__) {
					var table = dict ({1: dict ({'will': 0, 'ref': 2, 'bab': 1, 'fort': 2}), 2: dict ({'will': 0, 'ref': 3, 'bab': 2, 'fort': 3}), 3: dict ({'will': 1, 'ref': 3, 'bab': 3, 'fort': 3}), 4: dict ({'will': 1, 'ref': 4, 'bab': 4, 'fort': 4}), 5: dict ({'will': 1, 'ref': 4, 'bab': 5, 'fort': 4}), 6: dict ({'will': 2, 'ref': 5, 'bab': 6, 'fort': 5}), 7: dict ({'will': 2, 'ref': 5, 'bab': 7, 'fort': 5}), 8: dict ({'will': 2, 'ref': 6, 'bab': 8, 'fort': 6}), 9: dict ({'will': 3, 'ref': 6, 'bab': 9, 'fort': 6}), 10: dict ({'will': 3, 'ref': 7, 'bab': 10, 'fort': 7}), 11: dict ({'will': 3, 'ref': 7, 'bab': 11, 'fort': 7}), 12: dict ({'will': 4, 'ref': 8, 'bab': 12, 'fort': 8}), 13: dict ({'will': 4, 'ref': 8, 'bab': 13, 'fort': 8}), 14: dict ({'will': 4, 'ref': 9, 'bab': 14, 'fort': 9}), 15: dict ({'will': 5, 'ref': 9, 'bab': 15, 'fort': 9}), 16: dict ({'will': 5, 'ref': 10, 'bab': 16, 'fort': 10}), 17: dict ({'will': 5, 'ref': 10, 'bab': 17, 'fort': 10}), 18: dict ({'will': 6, 'ref': 11, 'bab': 18, 'fort': 11}), 19: dict ({'will': 6, 'ref': 11, 'bab': 19, 'fort': 11}), 20: dict ({'will': 6, 'ref': 12, 'bab': 20, 'fort': 12}), 'hp': 10});
					__pragma__ ('<all>')
						__all__.table = table;
					__pragma__ ('</all>')
				}
	...
	__nest__ (
		...
		'rogue', {
			__all__: {
				__inited__: false,
				__init__: function (__all__) {
					var table = dict ({1: dict ({'will': 0, 'ref': 2, 'bab': 0, 'fort': 0}), 2: dict ({'will': 0, 'ref': 3, 'bab': 1, 'fort': 0}), 3: dict ({'will': 1, 'ref': 3, 'bab': 2, 'fort': 1}), 4: dict ({'will': 1, 'ref': 4, 'bab': 3, 'fort': 1}), 5: dict ({'will': 1, 'ref': 4, 'bab': 3, 'fort': 1}), 6: dict ({'will': 2, 'ref': 5, 'bab': 4, 'fort': 2}), 7: dict ({'will': 2, 'ref': 5, 'bab': 5, 'fort': 2}), 8: dict ({'will': 2, 'ref': 6, 'bab': 6, 'fort': 2}), 9: dict ({'will': 3, 'ref': 6, 'bab': 6, 'fort': 3}), 10: dict ({'will': 3, 'ref': 7, 'bab': 7, 'fort': 3}), 11: dict ({'will': 3, 'ref': 7, 'bab': 8, 'fort': 3}), 12: dict ({'will': 4, 'ref': 8, 'bab': 9, 'fort': 4}), 13: dict ({'will': 4, 'ref': 8, 'bab': 9, 'fort': 4}), 14: dict ({'will': 4, 'ref': 9, 'bab': 10, 'fort': 4}), 15: dict ({'will': 5, 'ref': 9, 'bab': 11, 'fort': 5}), 16: dict ({'will': 5, 'ref': 10, 'bab': 12, 'fort': 5}), 17: dict ({'will': 5, 'ref': 10, 'bab': 12, 'fort': 5}), 18: dict ({'will': 6, 'ref': 11, 'bab': 13, 'fort': 6}), 19: dict ({'will': 6, 'ref': 11, 'bab': 14, 'fort': 6}), 20: dict ({'will': 6, 'ref': 12, 'bab': 15, 'fort': 6}), 'hp': 8});
					__pragma__ ('<all>')
						__all__.table = table;
					__pragma__ ('</all>')
				}
	...
	__nest__ (
		...
		'skills', {
			__all__: {
				__inited__: false,
				__init__: function (__all__) {
					var list = dict ({'acrobatics': 'dex', 'apraise': 'int', 'bluff': 'cha', 'climb': 'str', 'craft': 'int', 'diplomacy': 'cha', 'disable device': 'dex', 'disguise': 'cha', 'escape artist': 'dex', 'fly': 'dex', 'heal': 'wis', 'intimidate': 'cha', 'knowledge arcana': 'int', 'knowledge dungeoneering': 'int', 'knowledge engineering': 'int', 'knowledge geography': 'int', 'knowledge history': 'int', 'knowledge local': 'int', 'knowledge nature': 'int', 'knowledge nobility': 'int', 'knowledge planes': 'int', 'knowledge religion': 'int', 'linguistics': 'int', 'perception': 'wis', 'perform act': 'cha', 'perform comedy': 'cha', 'perform dance': 'cha', 'perform keyboard': 'cha', 'perform oritory': 'cha', 'perform percussion': 'cha', 'perform stringed': 'cha', 'perform wind': 'cha', 'perform sing': 'cha', 'profession': 'wis', 'ride': 'dex', 'sense motive': 'wis', 'slight of hand': 'dex', 'spell craft': 'int', 'stealth': 'dex', 'survival': 'wis', 'swim': 'str', 'use magic device': 'cha'});
					__pragma__ ('<all>')
						__all__.list = list;
					__pragma__ ('</all>')
				}
	...
	__nest__ (
		...
		'sorcerer', {
			__all__: {
				__inited__: false,
				__init__: function (__all__) {
					var table = dict ({1: dict ({'will': 2, 'ref': 0, 'bab': 0, 'fort': 0}), 2: dict ({'will': 3, 'ref': 0, 'bab': 1, 'fort': 0}), 3: dict ({'will': 3, 'ref': 1, 'bab': 1, 'fort': 1}), 4: dict ({'will': 4, 'ref': 1, 'bab': 2, 'fort': 1}), 5: dict ({'will': 4, 'ref': 1, 'bab': 2, 'fort': 1}), 6: dict ({'will': 5, 'ref': 2, 'bab': 3, 'fort': 2}), 7: dict ({'will': 5, 'ref': 2, 'bab': 3, 'fort': 2}), 8: dict ({'will': 6, 'ref': 2, 'bab': 4, 'fort': 2}), 9: dict ({'will': 6, 'ref': 3, 'bab': 4, 'fort': 3}), 10: dict ({'will': 7, 'ref': 3, 'bab': 5, 'fort': 3}), 11: dict ({'will': 7, 'ref': 3, 'bab': 5, 'fort': 3}), 12: dict ({'will': 8, 'ref': 4, 'bab': 6, 'fort': 4}), 13: dict ({'will': 8, 'ref': 4, 'bab': 6, 'fort': 4}), 14: dict ({'will': 9, 'ref': 4, 'bab': 7, 'fort': 4}), 15: dict ({'will': 9, 'ref': 5, 'bab': 7, 'fort': 5}), 16: dict ({'will': 10, 'ref': 5, 'bab': 8, 'fort': 5}), 17: dict ({'will': 10, 'ref': 5, 'bab': 8, 'fort': 5}), 18: dict ({'will': 11, 'ref': 6, 'bab': 9, 'fort': 6}), 19: dict ({'will': 11, 'ref': 6, 'bab': 9, 'fort': 6}), 20: dict ({'will': 12, 'ref': 6, 'bab': 10, 'fort': 6}), 'hp': 6});
					__pragma__ ('<all>')
						__all__.table = table;
					__pragma__ ('</all>')
				}
